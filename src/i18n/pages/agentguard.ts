...
export const agentguardCopy: Record<Locale, AgentGuardCopy> = {
  zh: {
    ...
    runtime: { eyebrow: "AGENTGUARD 交互边界运行时", title: "AgentGuard 如何守住行动边界", body: "持续追踪数据、授权与行动影响，在风险转化为真实后果前执行最小必要控制" },
    demo: {
      play: "播放官方演示",
    ...
    evidence: {
      ...
      items: [
        ...
        { title: "女娲实验室研究", body: "前沿风险、智能体安全与 AI 控制研究。", label: "研究成果", href: "/nuwa/research" },
      ],
    },
    cta: { title: "为智能体运行环境建立控制边界", body: "说明技术栈、关键权限与部署约束，加入产品心愿单。", primary: "加入心愿单", github: "查看社区版" },
  },
  en: {
    ...
    evidence: {
      ...
      items: [
        ...
        { title: "Safety models", body: "Thought, intent, and reasoning safety models.", label: "Ecosystem", href: "/open-ecosystem" },
        { title: "NUWA research", body: "Frontier risk, agent safety, and AI control.", label: "Research", href: "/nuwa/research" },
      ],
    },
    cta: { title: "Set a control boundary for agent runtime.", body: "Share your stack, critical permissions, and deployment constraints through the product waitlist.", primary: "Join the waitlist", github: "Community Edition" },
  },
};
