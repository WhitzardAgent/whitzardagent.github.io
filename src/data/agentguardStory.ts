...
export const storyPageCopy = {
  zh: {
    ...
    challenges: { eyebrow: "企业智能体风险", title: "智能体时代带来全新安全挑战", items: ["智能体快速扩散，安全团队缺少统一视图", "智能体继承用户与系统的高权限", "风险跨模型、工具、数据与多步行动形成", "传统控制无法理解任务目标与执行上下文"], closing: "AgentGuard 将运行时上下文转化为可执行的安全边界" },
  ...
  en: {
    ...
    challenges: { eyebrow: "ENTERPRISE AGENT RISK", title: "The agent era creates a new security frontier", items: ["Agent sprawl leaves security teams without a unified view", "Agents inherit powerful user and system privileges", "Risk forms across models, tools, data, and multi-step action", "Traditional controls cannot understand task intent and execution context"], closing: "AgentGuard turns runtime context into enforceable security boundaries" },
